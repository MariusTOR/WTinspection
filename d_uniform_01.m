function [r, seed_new] = d_uniform_01(seed)

%% D_UNIFORM_01 is a uniform random number generator.
%
% Discussion:
%
...
% the output random number. SEED should not be 0, because
% that will result in R = 0 and SEED_NEW = 0.
%
